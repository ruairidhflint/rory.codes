---
layout: 'writing.njk'
title: Small Joys of Fatherhood
permalink: /small-joys-of-fatherhood/
description: Phantom rocking, the dad nod, and other things nobody tells you about.
date: '2026-04-09'
---

> Quick housekeeping before we dive in. I've started a Substack dedicated to fatherhood writing. This piece is cross-posted there. If that's your kind of thing, [check it out](https://roryflint.substack.com/p/small-joys-of-fatherhood).

![Breezing Up (A Fair Wind) by Winslow Homer](/assets/images/breezing_up.webp 'Breezing Up (A Fair Wind) by Winslow Homer')
...
![Photo by Zac Edmonds (Unsplash)](/assets/images/diggers.webp 'Photo by Zac Edmonds (Unsplash)')

### Clicking the Car Seat
