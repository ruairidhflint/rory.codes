...
title: CV
permalink: /cv/
description: Rory Flint's CV and work history.
---

Rory Flint  
London, England

<a href="/assets/rory-flint-cv.pdf" download>Download PDF copy</a>

An Engineering Manager and former Senior Software Engineer with a passion for building strong teams and shipping meaningful products. Blending deep technical experience in web and mobile development with clear, pragmatic leadership to create alignment, momentum, and high standards across engineering.
...
- Architected and implemented cross-domain frontends for seamless user experiences.
- Took temporary leadership of the team during manager sickness and continued to effectively deliver initiatives.
...
- Winner of the global company-wide Above and Beyond award.
...
- Led the integration of MongoDB alongside an existing SQL database to enhance system capabilities.
- Mentored junior engineers on both technical and soft skills.
...
- Mentored emerging talent, providing guidance on technical skills, problem-solving, and professional growth in fast-paced, dynamic environments.
- Oversaw end-to-end project ownership, from initial concept to final delivery, ensuring reliable, well-designed outcomes amid evolving client needs and tight deadlines.
